...
<div class="easyui-layout" fit="true">
 ...
 $(document).ready(function(){
 		//给时间控件加上样式
 			$("#productInfoListtb").find("input[name='productTime_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 			$("#productInfoListtb").find("input[name='productTime_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 });
