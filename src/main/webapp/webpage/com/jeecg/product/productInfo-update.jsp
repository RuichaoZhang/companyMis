 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productTime" name="productTime" type="text" style="width: 150px" class="inputxt"  value='${productInfoPage.productTime}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productType" name="productType" type="text" style="width: 150px" class="inputxt"  value='${productInfoPage.productType}'>
							<span class="Validform_checktip"></span>
