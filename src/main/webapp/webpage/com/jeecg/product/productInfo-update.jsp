...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="productInfoController.do?doUpdate" tiptype="1" callback="jeecgFormFileCallBack@Override">
  ...
  <script src = "webpage/com/jeecg/product/productInfo.js"></script>		
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "productInfoController.do?getFiles&id=" +  cgFormId,
