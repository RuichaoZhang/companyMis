...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="productInfoController.do?doAdd" tiptype="1" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							   <input id="productTime" name="productTime" type="text" style="width: 150px" 
...
>
				...
				<tr>
					...
					<td class="value textarea-css">
						<textarea id="productContent" name="productContent" type="text" class="textarea-css"></textarea>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
								...
								<div class="form jeecgDetail"> 
										...
										$(function(){
											$('#productLink').uploadify({
												...
												onUploadStart : function(file) { 
													...
													$('#productLink').uploadify("settings", "formData", {
														'cgFormId':cgFormId,
														'cgFormName':'product_info',
														'cgFormField':'PRODUCT_LINK'
													});
												} ,
									...
									<span id="file_uploadspan"><input type="file" name="productLink" id="productLink" /></span> 
								</div> 
								<div class="form" id="filediv_file"></div>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">请选择上传的图片</label>
						</td>
				</tr>
			</table>
		</t:formvalid>
