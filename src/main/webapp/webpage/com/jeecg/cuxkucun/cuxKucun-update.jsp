...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cuxKucunController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinType" name="shangpinType" type="text" style="width: 150px" class="inputxt"  value='${cuxKucunPage.shangpinType}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinShuliang" name="shangpinShuliang" type="text" style="width: 150px" class="inputxt"  value='${cuxKucunPage.shangpinShuliang}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinBianhao" name="shangpinBianhao" type="text" style="width: 150px" class="inputxt"  value='${cuxKucunPage.shangpinBianhao}'>
							<span class="Validform_checktip"></span>
