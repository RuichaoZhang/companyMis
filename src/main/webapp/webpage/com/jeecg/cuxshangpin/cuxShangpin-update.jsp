...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cuxShangpinController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinMingcheng" name="shangpinMingcheng" type="text" style="width: 150px" class="inputxt"  value='${cuxShangpinPage.shangpinMingcheng}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinRukjiage" name="shangpinRukjiage" type="text" style="width: 150px" class="inputxt"  value='${cuxShangpinPage.shangpinRukjiage}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="shangpinDanjia" name="shangpinDanjia" type="text" style="width: 150px" class="inputxt"  value='${cuxShangpinPage.shangpinDanjia}'>
							<span class="Validform_checktip"></span>
