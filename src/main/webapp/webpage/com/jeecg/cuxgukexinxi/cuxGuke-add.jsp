...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cuxGukeController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="gukeName" name="gukeName" type="text" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="gukeShouji" name="gukeShouji" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="gukeDizhi" name="gukeDizhi" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
