...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="boardInfoList" checkbox="true" fitColumns="false" title="留言板表" actionUrl="boardInfoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="处理人"  field="boadrDeal"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="留言人姓名"  field="boadrPerson"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="电话"  field="boadrTel" formatter="yyyy-MM-dd hh:mm:ss"   queryMode="single"  width="120"></t:dgCol>
 ...
 $(document).ready(function(){
 		//给时间控件加上样式
 			$("#boardInfoListtb").find("input[name='boadrTel']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 });
