 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="boadrDeal" name="boadrDeal" type="text" style="width: 150px" class="inputxt"  value='${boardInfoPage.boadrDeal}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="boadrTel" name="boadrTel" type="text" style="width: 150px" class="inputxt"  value='${boardInfoPage.boadrTel}'>
							<span class="Validform_checktip"></span>
