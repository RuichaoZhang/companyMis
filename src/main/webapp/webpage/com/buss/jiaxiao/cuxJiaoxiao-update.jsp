...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cuxJiaoxiaoController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="jiaoxiaoName" name="jiaoxiaoName" type="text" style="width: 150px" class="inputxt" value='${cuxJiaoxiaoPage.jiaoxiaoName}'>
			...
			<td class="value">
		     	 <input id="xiaozhangName" name="xiaozhangName" type="text" style="width: 150px" class="inputxt" value='${cuxJiaoxiaoPage.xiaozhangName}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="shengfen" name="shengfen" type="text" style="width: 150px" class="inputxt" value='${cuxJiaoxiaoPage.shengfen}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="chengshi" name="chengshi" type="text" style="width: 150px" class="inputxt" value='${cuxJiaoxiaoPage.chengshi}'>
				<span class="Validform_checktip"></span>
