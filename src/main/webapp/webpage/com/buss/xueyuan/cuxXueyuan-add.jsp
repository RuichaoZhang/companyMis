...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cuxXueyuanController.do?doAdd">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="xueyuanName" name="xueyuanName" type="text" style="width: 150px" class="inputxt">
			...
			<td class="value">
		     	 <input id="xueyuanDianhua" name="xueyuanDianhua" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="xueyuanJiaxiao" name="xueyuanJiaxiao" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
